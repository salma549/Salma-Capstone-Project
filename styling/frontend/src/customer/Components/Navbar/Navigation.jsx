...
export default function Navigation() {
  ...
  return (
    ...
    <span className="ml-3 block text-base font-medium text-gray-900">
      ...
      <header className="relative bg-[#9cf6f6]">
        <p className="flex h-10 items-center justify-center bg-[#0a141b] px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
            ...
            <div className="flex h-16 items-center px-11">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  >
                    <ShoppingBagIcon
                      className=" border-[#9155FD] h-6 w-6 flex-shrink-0 text-gray-060 group-hover:text-gray-800"
                      aria-hidden="true"
                    />
